...
Feel free to check the [issues page](https://github.com/kennedyowusu/math_magician/issues).
...
This project is [MIT](https://github.com/kennedyowusu/math_magician/blob/develop/MIT.md) licensed.
